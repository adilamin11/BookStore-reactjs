        ...
        <div className="w-full md:w-1/2 mt-12 md:mt-32 order-2 md:order-1">
          <div className="space-y-8">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-center leading-snug">
              Discover <span className="text-purple-500">endless</span>{' '}
              possibilities and{' '}
              <span className="text-orange-400 underline decoration-dotted">
                learn
              </span>{' '}
              something <span className="text-blue-500">amazing</span> every
              day!
            </h1>
